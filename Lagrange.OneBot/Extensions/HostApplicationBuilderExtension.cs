        ...
        builder.Services.AddOptions()
            .AddSingleton(services => // Realm Configuration
            {
                ...
                if (File.Exists(litedb)) {
                    ...
                    logger.LogCritical("Please delete {0} if you no longer need the data in the database; otherwise, please refer to https://lagrangedev.github.io/Lagrange.Doc/Lagrange.OneBot/#从-litedb-迁移到-realm to migrate the database to Realm", litedb);
