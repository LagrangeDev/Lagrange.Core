...
internal class GroupAiRecordEvent : ProtocolEvent
{
    ...
    private GroupAiRecordEvent(int resultCode, RecordEntity recordEntity) : base(resultCode) { Record = recordEntity; }

    private GroupAiRecordEvent(int resultCode, string errMsg) : base(resultCode) { ErrorMessage = errMsg; }
