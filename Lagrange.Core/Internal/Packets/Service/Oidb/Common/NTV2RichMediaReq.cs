...
internal class ForwardPicExtraInfo
{

    [ProtoMember(1)] public int f1 { get; set; }

    [ProtoMember(3)] public int f3 { get; set; }

    [ProtoMember(4)] public int f4 { get; set; }

    [ProtoMember(9)] public byte[] f9 { get; set; }

    [ProtoMember(10)] public int f10 { get; set; }

    [ProtoMember(12)] public byte[] f12 { get; set; }

    [ProtoMember(18)] public byte[] f18 { get; set; }

    [ProtoMember(19)] public byte[] f19 { get; set; }

    [ProtoMember(21)] public byte[] f21Pb { get; set; }

    [ProtoMember(30)] public string PicUrl { get; set; }

    [ProtoMember(31)] public byte[] f31 { get; }
