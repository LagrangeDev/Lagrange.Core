...
{
    protected override bool Build(VideoGroupUploadEvent input, BotKeystore keystore, BotAppInfo appInfo, BotDeviceInfo device,
        ...
        out VideoGroupUploadEvent output, out List<ProtocolEvent>? extraEvents)
    {
        ...
        output = VideoGroupUploadEvent.Result((int)packet.ErrorCode, upload.UKey, upload.MsgInfo, upload.IPv4s, compat);
        extraEvents = null;
        return true;
    }
}