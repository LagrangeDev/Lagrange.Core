...
{
    protected override bool Build(FetchGroupsEvent input, BotKeystore keystore, BotAppInfo appInfo,
        ...
        out FetchGroupsEvent output, out List<ProtocolEvent>? extraEvents)
    {
        ...
        {
            var i = raw.Info;
            return new BotGroup(raw.GroupUin, i.GroupName, raw.CustomInfo.Remark, i.MemberCount, i.MemberMax, i.CreatedTime, i.Description, i.Question, i.Announcement);
        }).ToList();
