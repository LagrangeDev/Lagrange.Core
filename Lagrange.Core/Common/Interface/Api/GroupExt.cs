...
public static class GroupExt
{
    ...
    public static Task<bool> SetGroupBotHD(this BotContext bot, uint targetUin, uint groupUin, string? data)
        => bot.ContextCollection.Business.OperationLogic.SetGroupBotHD(targetUin, groupUin, data);
